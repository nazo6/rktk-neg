...
const L0: LayerMap = [
    ...
    [ L_CTRL, L_GUI , TG(2) , L_ALT , L3SPC , L2SPC , SPACE , _____ , /**/ BS    , BS    , ENTER , _____ , _____ , _____ ,R_SHFT,R_CTRL],
];
...
const L2: LayerMap = [
    ...
    [ _____ , _____ , DELETE, END   , PGDN  , _____ , _____ ,_____ , /**/ _____ ,_____ , _____ , M_L   ,MO_SCRL, M_R   , _____ , VOLUP ],
    [ _____ , _____ , _____ , _____ , _____ , _____ , _____ ,_____ , /**/ _____ ,_____ , _____ , M_BCK , M_MID , M_FWD , _____ , VOLDN ],
